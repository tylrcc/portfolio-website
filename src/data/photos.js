...
export const PHOTOS = [
  ...
  shot('nature-modern', 'Glass & stone', 'x-pro3', 'Elsewhere', 'landscape'),
  shot('dc-lincoln', 'Memorial dusk', 'x-pro3', 'Washington, DC', 'landscape'),
  shot('dc-lincoln-statue', 'Lincoln', 'x-pro3', 'Washington, DC', 'portrait'),
  ...
  shot('trop-frog', 'Night frog', 'x-pro3', 'Tropics', 'portrait'),
  shot('trop-snake', 'Green snake', 'x-pro3', 'Tropics', 'landscape'),
  ...
  shot('dc-chinatown', 'Friendship arch', 'x-pro3', 'Washington, DC', 'portrait'),
  shot('dc-skyline', 'City night', 'x-pro3', 'Washington, DC', 'portrait'),
