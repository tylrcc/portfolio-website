...
export const PHOTOS = [
  ...
  shot('euro-hills', 'Rolling hills', 'x-pro3', 'Lisbon', 'landscape'),
  shot('euro-vineyard', 'Vine rows', 'x-pro3', 'Portugal', 'landscape'),
  shot('euro-maat', 'MAAT', 'x-pro3', 'Lisbon', 'landscape'),
  shot('euro-steps', 'Stone steps', 'x-pro3', 'Lisbon', 'landscape'),
